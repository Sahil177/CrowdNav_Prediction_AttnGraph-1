...
def main():
	...
	# parser.add_argument('--model_dir', type=str, default='trained_models/my_finetune')
	...
	# parser.add_argument('--test_model', type=str, default='05400.pt')
